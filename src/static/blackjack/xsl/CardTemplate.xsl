                ...
                <xsl:otherwise>
                    ...
                    <symbol id="valueBox{$id}">
                        <svg height="2" width="1" viewBox="0 0 1 2">
                            ...
                            <image x="0" y="1" width="0.6" height="0.6" xlink:href="../src/static/blackjack/assets/icons/{$cardType}.svg"/>
                        </svg>
                    </symbol>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="$cardValue = 'K'">
                            <image x="0.1" y="1" width="4.9" height="5" xlink:href="../src/static/blackjack/assets/icons/{$cardColor}/King.svg"/>
                        </xsl:when>
                        <xsl:when test="$cardValue = 'Q'">
                            <image x="0.1" y="1" width="4.9" height="5" xlink:href="../src/static/blackjack/assets/icons/{$cardColor}/Queen.svg"/>
                        </xsl:when>
                        <xsl:when test="$cardValue = 'J'">
                            <image x="0.1" y="1" width="4.9" height="5" xlink:href="../src/static/blackjack/assets/icons/{$cardColor}/Jack.svg"/>
                        </xsl:when>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="@rotate = 'true'">
                                            <image x="{$currentX}" y="{$currentY}" width="1" height="1"
                                                   xlink:href="../src/static/blackjack/assets/icons/{$cardType}.svg" transform="rotate(180 {$currentX + 0.5} {$currentY + 0.5})"/>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <image x="{$currentX}" y="{$currentY}" width="1" height="1" xlink:href="../src/static/blackjack/assets/icons/{$cardType}.svg"/>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </xsl:for-each>
                            </svg>
